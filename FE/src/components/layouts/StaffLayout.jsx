          ...
          <ul className="space-y-2 px-2">
            ...
            <li>
              ...
              >
                ...
                {isSidebarOpen && (
                  <span className="ml-3">Products Management</span>
                )}
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              >
                ...
                {isSidebarOpen && (
                  <span className="ml-3">My Schedule Task</span>
                )}
              </Link>
            </li>
          </ul>
        </nav>
        <div className="mt-8 pt-4 border-t border-green-600 px-2">
          <button
            onClick={logout}
            className="flex items-center w-full p-3 hover:bg-green-600 rounded-lg transition duration-200"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
